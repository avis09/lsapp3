...
var form_invalid_mobile_no =
    "Invalid mobile number. Required format : 9XXXXXXXXX";
...
var validate = {
    standard: function(element) {
        ...
        var error_message =
            "<span class='validate_error_message'>" +
            form_empty_error +
            "<br></span>";
        ...
        $(".alphaonly").each(function() {
            ...
            if (/^[a-zA-Z -]*$/.test(str) == false) {
                ...
                $(this).addClass("err_inputs");
                $(
                    "<span class='validate_error_message'>This field only required only Letters.<br></span>"
                ).insertAfter(this);
            }
        });
        ...
        $(element).each(function() {
            ...
            if (element_script != undefined) {
                ...
                if (element_script.indexOf("<script") != -1) {
                    ...
                    $(this).addClass("err_inputs");
                    $(
                        "<span class='validate_error_message' style='color: red;'>" +
                            form_script +
                            "<br></span>"
                    ).insertAfter(this);
                }
