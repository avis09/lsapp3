...
@section('title')
    <title>Audit Trails | ITD BROS</title>
@endsection
...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-calendar-o"></i> Audit Trails </h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="#">Audit Trails</a></li>
            </ul>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                columns: [
                    ...
                    { data: null,
                        render:function(data){
                            return data.users.firstName+' '+data.users.lastName;
