...
<html>
  ...
  <body>
    ...
    <section class="login-content bg-primary">
      ...
      <div class="login-box">
          <div class="container">
        <form class="form-reset-password" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input id="new-password" type="text" class="form-control password" name="new_password" autofocus>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-lock fa-lg fa-fw"></i>Reset Password</button>
          </div>
        </form>     
    </div>    
      </div>
